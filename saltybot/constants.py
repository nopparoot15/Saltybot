...
REFRESH_AT_DAY             = int(os.getenv("SALTY_REFRESH_AT_DAY", "1"))
REFRESH_AT_MONTH           = int(os.getenv("SALTY_REFRESH_AT_MONTH", "1"))
REFRESH_AT_WEEKDAY         = int(os.getenv("SALTY_REFRESH_AT_WEEKDAY", "0"))
